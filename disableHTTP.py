...
if redirections['success']:
    for redirection in redirections["result"]:
        if redirection["enabled"] and redirection["src_ip"]=='0.0.0.0' and redirection["lan_ip"]=='192.168.0.253' and redirection["ip_proto"]=='tcp' and (redirection["wan_port_start"]==80 or redirection["wan_port_start"]==443):
